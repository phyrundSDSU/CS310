...
public class LinkedListTester {
    ...
    public static void main(String [] args) { 
        ...
        System.out.println("Printing items in Stack");
        // Testing Stack
        ...
        for(Integer i:stacktest){
          System.out.println(i);   
    }
        
        
        //Testing Queue
        Queue<Integer> queuetest = new Queue<Integer>();
        ...
        System.out.println("Printing items in Queue");
        
        for(Integer i:queuetest){
        	System.out.println(i);
        }
}
}